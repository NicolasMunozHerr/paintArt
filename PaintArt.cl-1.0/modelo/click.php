...
class click{
    ...
    public function cantidadClickArtista($idArtista){
        ...
        try
        {
            ...
            select count(artista_has_clicks.idArtistaClick) as 'cantidad'
    ...
    public function cantidadClickUltimosMesesArtista($idArtista){
        $lista = new ArrayList();
            try
            {
                ...
                $resul = $this->pdo->useConnection()->prepare("
                    select 
                        count(artista_has_clicks.idArtistaClick) as 'cantidad',
    ...
    public function cantidadClickObra($idArtista){
        ...
        try
        {
            ...
            $resul = $this->pdo->useConnection()->prepare("
            select 
                count(obra_has_clicks.idObraClick) as 'cantidad' ,
                artista.idArtista
            from
                obra_has_clicks,
                clicks, 
