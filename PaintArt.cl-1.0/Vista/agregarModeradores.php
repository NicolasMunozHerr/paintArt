...
<head>
    ...
    <link rel="stylesheet" href="Css/cssAdministrarModeradores.css">
        ...
        <div style="width: 100%; height: auto;" class="listaPeticiones">
          ...
          <div class="contBarra">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
              <div class="container-fluid">
                <div class="barraBusqueda">
                        <input id="informacionBusqueda"class=" form-control Search" type="text" placeholder="Buscar">                    
                  </div>
                  <button style="float: right;" id="buscar" class="btn btn-secondary my-2 my-sm-0" type="submit">Buscar</button>
            ...
            <div id="reglon">
              ...
              <div style="float: right" class="botoneraApruebaRechazo">
                <div class="apruebo"><button type="submit" style="width: 100%; height:100% ; border: none;" ><img src="imagenes/aceptar.png" alt=""></button></div>
                <div class="rechazo"><button type="submit" style="width: 100%; height:100% ; border: none;" ><img src="imagenes/rechazar.png" alt=""></button></div>
              </div>
              <div style="text-align:left " class="peticion">
                <div class="foto"><img src="imagenes/usuario.png" alt=""></div>
                <div class="nombreYapellido">
...
<script type="text/javascript">
  ...
  $(document).on("click", "#apruebo",function(){
    ...
    $(document).on("click", "#buscar",function(){
      var parametros=5;
      var id= document.getElementById("informacionBusqueda").value;
        $.ajax({
        url:'../controlador/controllerAdminModeradores.php',
        method:'POST',
        data:{parametros:parametros,id:id,},
