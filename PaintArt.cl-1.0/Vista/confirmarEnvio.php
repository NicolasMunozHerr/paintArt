...
<script type="text/javascript">
  ...
  function obtener_datos(){
    ...
    $.ajax({
      url:'../controlador/controllerConfirmarEnvio.php',
      method:'POST',
  ...
  $(document).on("click", "#enviar",function(){
    swal("Para enviar necesitaremos el codigo de envio de la empresa xxxxx", {
    content: "input",
    })
    .then((value) => {
       
        if(value==""||value==null||value==0){
            swal('No se ha introducido el codigo de envio',value,'info');
            ...
            $.ajax({
                url:'../controlador/controllerConfirmarEnvio.php',
                method:"POST",
                data:{parametros:parametros,id:id,codigoEnvio:codigoEnvio },
                success: function(data){
                    obtener_datos();
                    swal('El resultado fue',data, 'info');
                }
            });
    ...
    $(document).on("click", "#enviarSub",function(){
    swal("Para enviar necesitaremos el codigo de envio de la empresa xxxxx", {
    content: "input",
    })
    .then((value) => {
