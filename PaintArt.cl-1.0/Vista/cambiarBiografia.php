...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      border: 1px solid #dee2e6;"> 
             <h2 style="margin-top: 20px; ">Cambiar Biografia</h2>
            <div class="form-group formulario" > 
              <form action="../controlador/cambiarBiografia.php" method="post" enctype="multipart/form-data">
                  <br>
                <table style="margin:auto; text-align:center; width:60%" class="formularioRegistrar"> 
                   
                        <td><h4>Nueva Biografia</h4></td> 
                      </tr> 
                      <tr>
                          <td><textarea name="biografia" style= "border: 0px; border-radius:0px ; width:100%" class="form-control" id="exampleTextarea" rows="12" required></textarea></td> 
                      </tr>
                      
                    <tr> 
                      <td style="text-align: right; "> 
                        <br>
                        <input type="submit" name="subir" style="background-color: #212529; border-radius: 0px ; border-color: #212529; color: #dee2e6;" class="btn btn-primary" value="Cambiar biografia">
