    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> 
      ...
      <ul class="navbar-nav me-auto barrita"> 
        <div class="collapse navbar-collapse" id="navbarColor03"> 
            ...
            <li class="nav-item"> 
              <a class="nav-link" href="listaObras.php?cat=100">Populares de la semana</a> 
            </li> 
            ...
            <div class="form-group formulario" > 
              <form action="../controlador/cambiarBiografia.php" method="post" enctype="multipart/form-data">
                <table class="formularioRegistrar"> 
                        ...
                        <td><h5>Nueva Biografia</h5></td> 
                      </tr> 
                      <tr>
                          <td><textarea name="biografia" style= "border: 0px; border-radius:0px ;" class="form-control" id="exampleTextarea" rows="3" required></textarea></td> 
                      </tr>
                      
                    <tr> 
                      <td style="text-align: right; "> 
                        <br>
                        <input type="submit" name="subir" style="background-color: #212529; border-radius: 0px ; border-color: #212529; color: #dee2e6;" class="btn btn-primary" value="subir obra">
                      </td> 
                    </tr> 
                  </table> 
              </form>
