...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        ...
        -->
        <?php $controller->mostrarPerfil($online) ?>
        <div class="histoObras">
            <span class="tituloObras"><h3>Aca apareceran tus  Obras</h3></span>
            <br>
            <span class="tituloObras"><h5>  Animate a subir tu primera Obra: </h5> </span>
          
            
            
            <span class="tituloObras"><a href="subirObra.html"><h6 style="color:blue;"> Click aqui</h6></a></span>
