...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      border: 1px solid #dee2e6;"> 
            ...
            <form action="../controlador/controlladorRedesSociales.php" method="post" enctype="multipart/form-data">
                <table class="formularioRegistrar"> 
                    ...
                    <tr>
                        <td><input type="url" class="form-control" name="face" placeholder="Link de su red social" id="inputDefault" required></td>
                    </tr>
                    <tr> 
                        <td><h5>Intagram</h5></td> 
  
                      </tr> 
                      <tr>
                          <td><input type="url" class="form-control" name="insta" placeholder="Link de su red social" id="inputDefault" required></td>
                      </tr>
                      <tr> 
                        <td><h5>Twitter</h5></td> 
                      ...
                      <tr>
                          <td><input type="url" class="form-control" name="twitter" placeholder="Link de su red social" id="inputDefault" required></td>
                      </tr>
                    ...
                    <tr> 
                      ...
                      <tr>
                          <td><input type="url" class="form-control" name="tiktok" placeholder="Link de su red social" id="inputDefault" required></td>
                      </tr>
                     <!-- <tr>
