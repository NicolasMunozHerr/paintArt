...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h3 style="margin-top: 10px;margin-left: 10px;">Lista de reporte</h3>
        ...
        <!-- <div class="contenedorPetcion">
          <div style="width: 100%; height: auto;" class="listaPeticiones">
            <div style="text-align:left " class="peticion">
                ...
                <br>
                <h6>asunto: xxx</h6>
                <p>descripcion: xxxxxxxxxasjdoai askdpoakspd oaksodkap okap odkapo ksdoiasasdasjdo jaosidj oaidjdoi ajosijdaoisjoai joaisdjoaisjdo ijoijoasidjoai joiajosdi</p>
              
              </div>
            <div style="float: right; " class="botoneraApruebaRechazo">
                <div class="apruebo">a</div>
                <div class="rechazo">a</div>
            </div>
          </div>
        </div>
        <div class="contenedorPetcion">
...
<script type="text/javascript">
  ...
  function obtener_datos(){
    var parametros=1;
    $.ajax({
      url:'../controlador/controllerReporte.php',
      method:'POST',
