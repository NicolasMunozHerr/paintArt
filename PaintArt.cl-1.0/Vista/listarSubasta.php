<?php 
include_once '../controlador/controllerListarSubasta.php';
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        ...
        <div class="noticia">
          ...
          <table class="table ">
            <tr>
              <td ><h2>Subasta <?php echo $listaObra->mostraCate($cat)?></h2>
                    <br>
                    
              <td>
              <td> <a href="listarSubasta.php"> <button style="position:relative; left:25% "type="button" class="btn btn-warning">Ventas</button></a></td>
            </tr>
          </table>
