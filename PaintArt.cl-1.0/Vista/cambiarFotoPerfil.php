                ...
                <table style=" margin: auto"class="formularioRegistrar"> 
                    ...
                    <tr> 
                      <td style="text-align: right; "> 
                        <br>
                        <input type="submit" name="subir" style="color: #dee2e6;background-color: #212529; border-radius: 0px ; border-color: #212529; " class="btn btn-primary" value="Cambiar Foto de perfil">
                      </td> 
                    </tr> 
                  </table> 
              </form>
