    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div style="background-color:  #f8f9fa!important;     border: 1px solid rgba(0,0,0,.1);" class="container">
        ...
        <figcaption class="blockquote-footer">
            <cite style="font-size: large ;" title="Source Title">Epigrafe</cite>
        </figcaption>
        <br>
        <h6>askdpaskd askpda kspoka poak pskoa pokpd oaskpd oakspo kapo kapso kpaos kpaoskd paosk pako poaskpd aokspd oakps okaspdok apso kpaokd poask pdoakps okaps kapsokd paosk poakspo kapso kaposk dpaosk paosk paks pkoasp kapso kpadsko</h6>
        <br>
        <div class="noticia"> <img style="width: 30% ;max-width: 30%; height: 30%; max-height: 30%; margin-bottom: 20px;" src="imagenes/logoGiganPaintArt.jpg" alt=""></div>
