    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> 
      ...
      border: 1px solid #dee2e6;"> 
            ...
            <div class="form-group formulario" > 
                ...
                <form action="../controlador/controllerEnviarCorreo.php" method="post" >
                  <tr> 
                  ...
                  <tr> 
                    ...
                    <td style="text-align: right; ">
                      <br>
                      <button type="submit" style="background-color: #212529; border-radius: 0px ; border-color: #212529; " class="btn btn-primary">Enviar solicitud</button> 
                    </td> 
                  </tr> 
                </form>
                </table>
